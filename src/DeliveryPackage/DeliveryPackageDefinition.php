...
namespace Swag\PlanetExpress\DeliveryPackage;
...
use Swag\PlanetExpress\DeliveryBoy\DeliveryBoyDefinition;

class DeliveryPackageDefinition extends EntityDefinition
{
    public const ENTITY_NAME = 'swag_planet_express_delivery_package';
